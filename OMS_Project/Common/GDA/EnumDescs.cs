...
namespace Common.GDA
{
	...
	{
		private Dictionary<ModelCode, Type> property2enumType;

		public EnumDescs()
		{
			property2enumType = new Dictionary<ModelCode, Type>(3);
			...
			property2enumType.Add(ModelCode.ENERGYCONSUMER_CONSUMERCLASS, typeof(ConsumerClass));
		}
